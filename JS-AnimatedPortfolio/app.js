const boxContainer = document.querySelector(".gitBoxContainer");
...
window.addEventListener("scroll", () => {
    ...
    jobTitleContainer[0].style.backgroundPositionY = `${offsetY * 0.7}px`
    jobTitleContainer[1].style.backgroundPositionY = `${-offsetY * 0.7}px`
    jobTitle[0].style.transform = `translateX(calc(200vh - ${offsetY}px))`;
    jobTitle[1].style.transform = `translateX(calc(-300vh + ${offsetY}px))`;
    projectsTitle.style.transform = `translateY(${offsetY * 0.075}px)`;
